...
from efficientdet.dataset import WasteDataset, CocoDataset, Resizer, Normalizer, Augmenter, collater
...
def get_args():
    ...
    parser.add_argument('--type', type=str, default='simple', help='type of waste data')
    ...
    parser.add_argument('--data_path', type=str, default='/raid/wanfang/Documents', help='the root folder of dataset')
...
def train(opt):
    ...
    training_set = WasteDataset(root_dir=opt.data_path, type=opt.type,
                               transform=transforms.Compose([Normalizer(mean=params.mean, std=params.std),
                                                             Augmenter(),
                                                             Resizer(input_sizes[opt.compound_coef])]))
    training_generator = DataLoader(training_set, **training_params)

    val_set = WasteDataset(root_dir=opt.data_path, type=opt.type,
                          transform=transforms.Compose([Normalizer(mean=params.mean, std=params.std),
                                                        Resizer(input_sizes[opt.compound_coef])]))
